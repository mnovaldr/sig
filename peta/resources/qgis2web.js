...
map.getView().fit([12540257.532503, -891480.991775, 12542543.800713, -890319.118528], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Tematik Persebaran Kantor Notaris di Kecamatan Kedungkandang</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (328 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta Tematik Persebaran Kantor Notaris di Kecamatan Kedungkandang menggambarkan lokasi dan pola sebaran kantor notaris dalam wilayah administratif Kecamatan Kedungkandang. Peta ini disusun untuk memberikan informasi spasial mengenai keberadaan kantor notaris serta keterkaitannya dengan jaringan jalan dan lingkungan permukiman.';
            }
